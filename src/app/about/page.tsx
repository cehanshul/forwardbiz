...
export default function FinalAboutUsPage() {
  ...
  const founder = {
    ...
    bio: "Raji began her career in corporate banking, where she gained valuable insight into how businesses operate and grow. Transitioning into the IT/ITES sector, she built deep expertise in HR recruitment, team building, and sales leadership, always driven by the belief that people are the foundation of business success.",
  };
  ...
  return (
    <div className="bg-gray-900 4 font-sans antialiased text-gray-200">
      ...
      {/* Founder Section - Replaced Team Section with Single Profile */}
      <section id="founder" className="py-24 relative">
        <div className="max-w-screen-xl mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto animate-on-scroll opacity-0">
            <div className="bg-gray-800/20 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700/20 hover:border-blue-500/30 transition-all duration-300 flex flex-col md:flex-row">
              {/* Profile photo */}
              <div className="md:w-2/5 h-80 md:h-auto relative">
                <Image
                  height={200}
                  width={200}
                  src="/raji-founder.jpeg"
                  alt={founder.name}
                  className="w-full h-full object-cover object-center"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-gray-900/60 to-transparent md:bg-gradient-to-t"></div>

                {/* LinkedIn icon */}
                <a
                  href={founder.linkedin}
                  target="_blank"
                  className="absolute top-4 right-4 w-10 h-10 bg-blue-600/80 hover:bg-blue-500 text-white rounded-full flex items-center justify-center backdrop-blur-sm transition-all duration-300"
              ...
              <div className="md:w-3/5 p-8 md:p-10 relative">
                <div className="absolute -top-4 left-4 text-6xl text-blue-500/10">
                  "
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">
                  {founder.name}
                </h3>
                <p className="text-blue-400 text-sm mb-6">{founder.role}</p>
                <p className="text-gray-300 leading-relaxed relative z-10">
                  {founder.bio}
                </p>
                <p className="text-gray-300 leading-relaxed relative z-10 mt-4">
                  With over 12 years of experience, she founded Forward Biz to
                  bridge talent and performance. Helping organizations hire
                  smarter, build stronger teams, and convert opportunities into
                  measurable growth.
                </p>

                {/* Key stats */}
                <div className="grid grid-cols-2 gap-6 mt-8 pt-8 border-t border-gray-700/30">
